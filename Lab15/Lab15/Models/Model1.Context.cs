...
namespace Lab15.Models
{
    ...
    public partial class SchoolEntities : DbContext
    {
        ...
        public virtual ObjectResult<BuscarPersonaContrato_Result> BuscarPersonaContrato(Nullable<System.DateTime> hireDate)
        {
            var hireDateParameter = hireDate.HasValue ?
                new ObjectParameter("HireDate", hireDate) :
                new ObjectParameter("HireDate", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarPersonaContrato_Result>("BuscarPersonaContrato", hireDateParameter);
        }
    
        public virtual ObjectResult<BuscarPersonaData_Result> BuscarPersonaData(string busqueda)
        {
            var busquedaParameter = busqueda != null ?
                new ObjectParameter("Busqueda", busqueda) :
                new ObjectParameter("Busqueda", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarPersonaData_Result>("BuscarPersonaData", busquedaParameter);
        }
    
        public virtual ObjectResult<BuscarPersonaInscripcion_Result> BuscarPersonaInscripcion(Nullable<System.DateTime> enrollmentDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarPersonaInscripcion_Result>("BuscarPersonaInscripcion", enrollmentDateParameter);
        }
